package org.gameofthelife.client.network.handler.factory;
...
public class MessageFactoryImplementation {
	...
	/**
	 * load all class child of NetworkMessage on org.gameofthelife.client.network.messages with MessageHandlerController anotation
	 */
